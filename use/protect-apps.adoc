...
. Seleccione *aplicaciones* y, a continuación, seleccione el nombre de una aplicación.
. Seleccione *Protección de datos*.
. Seleccione la lista desplegable en la columna *acciones* para la instantánea deseada.
. Seleccione *Eliminar instantánea*.
...
. Seleccione la lista desplegable en la columna *acciones* para la copia de seguridad deseada.
